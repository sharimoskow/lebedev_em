...
Dual cells straddling two interfaces are handled by a sequential application
of the nodal formula: the two outer materials are homogenized first with the
...
% ============================================================
\section{Multi-Interface Cells: Sequential Backus}\label{sec:multilayer}
% ============================================================
...
\item \textbf{Adjacent pairs parallel, skip pair distinct}
      ...
      two interfaces with two distinct normals — sequential Backus applies
...
\subsection*{Sequential Backus for $M = 3$ materials}
...
If the sequential-Backus result has a maximum eigenvalue exceeding three times
...
The order of the two Backus steps matters.  The convention ``outer materials
