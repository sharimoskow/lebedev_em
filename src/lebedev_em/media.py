...
def from_geometry_exact(
    ...
    This is the exact-geometry counterpart to the lookup path
    :func:`from_sigma_func`.  Where the lookup path must estimate the interface
    normal (SVD) and sample the fractions, this path uses the geometry to
